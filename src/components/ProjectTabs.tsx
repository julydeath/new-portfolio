...
export const Tabs = ({
  ...
  return (
    <>
      <div className="text-white mx-auto text-6xl font-semibold pb-4">
        Featured Projects
      </div>
      <div className="text-gray-600 text-base mx-auto pb-14">
        See how i transformed ideas into engaging digital experience!
      </div>
